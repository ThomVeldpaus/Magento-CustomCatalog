...
namespace Thom\CustomCatalog\Model\Indexer\Product\Price\Action;
...
/**
 * Class Full
 * @package Thom\CustomCatalog\Model\Indexer\Product\Price\Action
 */
class Full extends \Magento\Catalog\Model\Indexer\Product\Price\Action\Full
{
     ...
     * Chunk size
     */
    const RANGE_CATEGORY_STEP = 50000000;

    /**
     * Chunk size for product
     */
    const RANGE_PRODUCT_STEP = 100000000000;
